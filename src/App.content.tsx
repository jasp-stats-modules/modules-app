...
const appContent = {
  ...
  content: {
    ...
    action_version_title: t({
      en: insert('{{action}} {{version}}'),
      nl: insert('{{action}} {{version}}'),
      fr: insert('{{action}} {{version}}'),
      de: insert('{{action}} {{version}}'),
      es: insert('{{action}} {{version}}'),
      it: insert('{{action}} {{version}}'),
      ar: insert('{{action}} {{version}}'),
      cs: insert('{{action}} {{version}}'),
      et: insert('{{action}} {{version}}'),
      eu: insert('{{action}} {{version}}'),
      gl: insert('{{action}} {{version}}'),
      hu: insert('{{action}} {{version}}'),
      id: insert('{{action}} {{version}}'),
      ja: insert('{{action}} {{version}}'),
      lt: insert('{{action}} {{version}}'),
      pl: insert('{{action}} {{version}}'),
      pt: insert('{{action}} {{version}}'),
      ru: insert('{{action}} {{version}}'),
      sq: insert('{{action}} {{version}}'),
      sr: insert('{{action}} {{version}}'),
      tr: insert('{{action}} {{version}}'),
      'zh-Hans': insert('{{action}} {{version}}'),
      'zh-Hant': insert('{{action}} {{version}}'),
    }),
    action_version_from_to_title: t({
      en: insert('{{action}} {{from}} → {{to}}'),
      nl: insert('{{action}} {{from}} → {{to}}'),
      fr: insert('{{action}} {{from}} → {{to}}'),
      de: insert('{{action}} {{from}} → {{to}}'),
      es: insert('{{action}} {{from}} → {{to}}'),
      it: insert('{{action}} {{from}} → {{to}}'),
      ar: insert('{{action}} {{from}} → {{to}}'),
      cs: insert('{{action}} {{from}} → {{to}}'),
      et: insert('{{action}} {{from}} → {{to}}'),
      eu: insert('{{action}} {{from}} → {{to}}'),
      gl: insert('{{action}} {{from}} → {{to}}'),
      hu: insert('{{action}} {{from}} → {{to}}'),
      id: insert('{{action}} {{from}} → {{to}}'),
      ja: insert('{{action}} {{from}} → {{to}}'),
      lt: insert('{{action}} {{from}} → {{to}}'),
      pl: insert('{{action}} {{from}} → {{to}}'),
      pt: insert('{{action}} {{from}} → {{to}}'),
      ru: insert('{{action}} {{from}} → {{to}}'),
      sq: insert('{{action}} {{from}} → {{to}}'),
      sr: insert('{{action}} {{from}} → {{to}}'),
      tr: insert('{{action}} {{from}} → {{to}}'),
      'zh-Hans': insert('{{action}} {{from}} → {{to}}'),
      'zh-Hant': insert('{{action}} {{from}} → {{to}}'),
    }),
    action_with_pre_release: t({
      en: insert('{{action}} {{preRelease}}'),
      nl: insert('{{action}} {{preRelease}}'),
      fr: insert('{{action}} {{preRelease}}'),
      de: insert('{{action}} {{preRelease}}'),
      es: insert('{{action}} {{preRelease}}'),
      it: insert('{{action}} {{preRelease}}'),
      ar: insert('{{action}} {{preRelease}}'),
      cs: insert('{{action}} {{preRelease}}'),
      et: insert('{{action}} {{preRelease}}'),
      eu: insert('{{action}} {{preRelease}}'),
      gl: insert('{{action}} {{preRelease}}'),
      hu: insert('{{action}} {{preRelease}}'),
      id: insert('{{action}} {{preRelease}}'),
      ja: insert('{{action}} {{preRelease}}'),
      lt: insert('{{action}} {{preRelease}}'),
      pl: insert('{{action}} {{preRelease}}'),
      pt: insert('{{action}} {{preRelease}}'),
      ru: insert('{{action}} {{preRelease}}'),
      sq: insert('{{action}} {{preRelease}}'),
      sr: insert('{{action}} {{preRelease}}'),
      tr: insert('{{action}} {{preRelease}}'),
      'zh-Hans': insert('{{action}} {{preRelease}}'),
      'zh-Hant': insert('{{action}} {{preRelease}}'),
    }),
    more_actions: t({
      en: 'More actions',
      nl: 'Meer acties',
    ...
    module_icon_alt: t({
      en: insert('{{name}} icon'),
      nl: insert('{{name}}-pictogram'),
      fr: insert('Icône de {{name}}'),
      de: insert('{{name}}-Symbol'),
      es: insert('Icono de {{name}}'),
      it: insert('Icona di {{name}}'),
      ar: insert('أيقونة {{name}}'),
      cs: insert('Ikona {{name}}'),
      et: insert('{{name}} ikoon'),
      eu: insert('{{name}} ikonoa'),
      gl: insert('Icona de {{name}}'),
      hu: insert('{{name}} ikonja'),
      id: insert('Ikon {{name}}'),
      ja: insert('{{name}} のアイコン'),
      lt: insert('{{name}} piktograma'),
      pl: insert('Ikona {{name}}'),
      pt: insert('Ícone de {{name}}'),
      ru: insert('Значок {{name}}'),
      sq: insert('Ikona e {{name}}'),
      sr: insert('Ikonica za {{name}}'),
      tr: insert('{{name}} simgesi'),
      'zh-Hans': insert('{{name}} 图标'),
      'zh-Hant': insert('{{name}} 圖示'),
    }),
    channel: t({
      en: 'Channel',
      nl: 'Kanaal',
...
模块中可能包含测试版。测试版用于在稳定版发布之前测试新模块或新功能，测试版可能有还未解决的错误。
...
此面板是 [JASP-MOD 專案](https://research-software-directory.org/projects/jasp-mod) 的一部分。`),
    ...
    downgrade: t({
      en: 'Downgrade to release',
      nl: 'Downgraden naar release',
      fr: 'Rétrograder vers la version',
      de: 'Auf Release downgraden',
      es: 'Degradar a la versión',
      it: 'Effettua il downgrade alla versione',
      ar: 'الرجوع إلى الإصدار',
      cs: 'Snížit na vydání',
      et: 'Langeta väljalaskeni',
      eu: 'Jaitsi bertsiora',
      gl: 'Degradar á versión',
      hu: 'Visszaállítás kiadásra',
      id: 'Turunkan ke rilis',
      ja: 'リリース版にダウングレード',
      lt: 'Sumažinti iki leidimo',
      pl: 'Obniż do wydania',
      pt: 'Reverter para a versão',
      ru: 'Понизить до релиза',
      sq: 'Ule në versionin e lëshimit',
      sr: 'Снизи на издање',
      tr: 'Sürümü kararlı sürüme düşür',
      'zh-Hans': '降级到发布版',
      'zh-Hant': '降級到發行版',
    }),
  },
