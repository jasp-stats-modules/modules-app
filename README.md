...
- s: Search term to filter modules. For example `?s=test` will show modules that mention "test" in their title or description. See info panel in app for more search term examples.
...
1. Fetches the git submodules of HEAD of main branch of the https://github.com/jasp-stats-modules/modules-registry repository.
   ...
   - to see translations of channel names, ensure there is a corresponding entry in [src/App.content.tsx](src/App.content.tsx)
