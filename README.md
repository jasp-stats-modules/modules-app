...
A web application hosted at [https://jasp-stats-modules.github.io/modules-app/](https://module-library.jasp-stats.org/) that allows you to search/filter all the available JASP modules and install them.
