...
- f: Font name. Use the name of a font installed on your system. For example use `SansSerif`. Besides OS fonts also `FreeSans` and `FiraCode-Retina` fonts are available.
